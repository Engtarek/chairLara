...
/* WEBPACK VAR INJECTION */(function($) {window.change_image = function (product_id, ch_layer_id2, img_pos) {
  $.ajax({ url: "/change_image/" + product_id + "/" + ch_layer_id2 + "/" + img_pos, success: function success(result) {
