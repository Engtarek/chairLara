...
<section class="content">
  <div class="row ">
    <div class="col-xs-6">
      ...
      <span style="font-weight: bold;font-size: 21px;">Users</span>

    </div>
    <div class="col-xs-4 col-xs-offset-2">
      <!-- <a href="{{url('/admin/users/create')}}" class="btn btn-default pull-right">Add User</a> -->
      <a href="{{url('/admin/create_new_user')}}" class="btn btn-default pull-right">Add new user with license</a>
    </div>
  </div>
  <hr>
  <div class="row">
...
var table = $('#data').DataTable({
    ...
    ajax: "{{ url('/admin/users/data') }}",//url get all data
