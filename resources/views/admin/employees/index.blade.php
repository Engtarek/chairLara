...
<section class="content">
  <div class="row ">
    <div class="col-xs-6">
      ...
      <span style="font-weight: bold;font-size: 21px;">Employees</span>

    </div>
    <div class="col-xs-4 col-xs-offset-2">
<a href="{{url('/admin/employees/create')}}" class="btn btn-default pull-right">Add Employee</a>
...
var table = $('#data').DataTable({
    ...
    ajax: "{{ url('/admin/employees/data') }}",//url get all data
