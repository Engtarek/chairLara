...
<section class="content">
  <div class="row ">
    <div class="col-xs-6">
      <span style="font-weight: bold;font-size: 21px;">Tokens</span>
    </div>
    <div class="col-xs-4 col-xs-offset-2">
      <a href="{{url('/admin/api_tokens/create')}}" class="btn btn-default pull-right">Add Token</a>
    </div>
  </div>
  <hr>
  <div class="row">
...
var table = $('#data').DataTable({
    ...
    ajax: "{{ url('/admin/api_tokens/data') }}",//url get all data
